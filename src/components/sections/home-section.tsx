...
export function HomeSection() {
  ...
  return (
    ...
    >
      <div className="grid items-start gap-y-3 sm:gap-y-8 lg:grid-cols-2 lg:gap-14">
        <div className="min-w-0 lg:col-start-1 lg:row-start-1">
          ...
          <p className="text-rc-blue/90 mb-0 max-w-xl text-lg sm:text-xl lg:mb-6">
            {m.home.subtitle}
          </p>
          <p className="text-rc-blue/80 hidden max-w-xl leading-relaxed lg:mb-10 lg:block">
            {m.home.intro}
          </p>
        </div>

        <div className="relative flex w-full justify-center lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:justify-end">
        ...
        <p className="text-rc-blue/80 max-w-xl leading-relaxed lg:hidden">
          {m.home.intro}
        </p>
